...
- (void)link_setup {
    ...
    self.backgroundHoverColor = [NSColor ez_dynamicColorLight:lightHoverColor dark:darkHoverColor];
    self.backgroundHighlightColor = [NSColor ez_dynamicColorLight:lightHighlightColor dark:darkHighlightColor];
}
