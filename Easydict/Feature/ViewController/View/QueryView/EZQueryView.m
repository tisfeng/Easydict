...
- (void)setup {
    ...
    textView.font = [NSFont systemFontOfSize:14 * EZConfiguration.shared.currentFontSizeRatio];
    ...
    [[NSNotificationCenter defaultCenter] addObserverForName:ChangeFontSizeView.changeFontSizeNotificationName object:nil queue:NSOperationQueue.mainQueue usingBlock:^(NSNotification * _Nonnull notification) {
        mm_strongify(self);
        self.textView.font = [NSFont systemFontOfSize:14 * EZConfiguration.shared.currentFontSizeRatio];
    }];
