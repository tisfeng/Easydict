...
enum GitHubModel: String, CaseIterable {
    ...
    case deepseek_v3_0324 = "deepseek/DeepSeek-V3-0324" // High

    case llama_3_3_70B_instruct = "Llama-3.3-70B-Instruct" // High

    case cohere_command_a = "cohere/cohere-command-a" // Low

    case mistral_small_2503 = "mistral-ai/mistral-small-2503" // Low
