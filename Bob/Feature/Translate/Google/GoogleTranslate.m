...
#define kGoogleRootPage(isCN) \
    (isCN ? @"https://translate.google.cn" : @"https://translate.google.com")
...
- (void)sendTranslateRequestWithText:(NSString *)text
                                from:(Language)from
                                  to:(Language)to
                          completion:
...
- (void)translate:(NSString *)text
    ...
    void (^translateBlock)(NSString *, Language, Language) = ^(
        ...
        [self
            sendTranslateRequestWithText:text
                                    from:langFrom
                                      to:langTo
...
- (void)detect:(NSString *)text
    ...
    [self
        sendTranslateRequestWithText:queryString
                                from:Language_auto
                                  to:Language_auto
                          completion:^(id _Nullable responseObject,
                                       NSString *_Nullable signText,
        ...
        mm_weakify(
            self)[self detect:text
                   completion:^(Language lang, NSError *_Nullable error) {
                       ...
                       NSString *sign =
                           [[self.signFunction callWithArguments:@[ text ]] toString];
                       NSString *url = [self
