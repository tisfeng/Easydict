...
extension OCRTestSample {
    /// English test cases collection
    static let englishCases: [OCRTestSample] = [
        .enText1, .enText2, .enTextBitcoin, .enTextReddit,
        .enPaper1, .enPaper2, .enPaper3, .enPaper4, .enPaper5, .enPaper6, .enPaper7, .enPaper8, .enPaper9, .enPaper10,
        .enPaper11, .enPaper12, .enPaper13, .enPaper14,
