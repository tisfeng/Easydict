...
- 采用版本：`v0.3.2`。
- peeled commit：`826b0a868f5802da8a4f2b90c8ac92e6cb2577b2`。
- Skills 安装器：`skills@1.5.24`。
- Codex 子代理安装器：`@tisfeng/codex-agents@0.3.2`。
...
`code-simplifier v0.3.2` 同时包含 `electron-typescript.md` 与 `swift-xcode.md` 条件规则。
