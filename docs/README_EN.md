...
| Slient Screenshot OCR       | Press the input translate shortcut key（default `⌥ + ⇧ + S`）to capture the area to be translated, translation results will be copied directly to the clipboard | ![屏幕录制2023-05-20 22 39 11](https://github.com/Jerry23011/Easydict/assets/89069957/c16f3c20-1748-411e-be04-11d8fe0e61af) |
