...
`Easydict` 是一个简洁易用的词典翻译 macOS App，能够轻松优雅地查找单词或翻译文本。Easydict 开箱即用，能自动识别输入文本语言，支持输入翻译，划词翻译和 OCR 截图翻译，可同时查询多个翻译服务结果，目前支持 [**🍎苹果系统词典**](./docs/How-to-use-macOS-system-dictionary-in-Easydict-zh.md)，[有道词典](https://www.youdao.com/)，[🍎**苹果系统翻译**](./docs/How-to-use-macOS-system-translation-in-Easydict-zh.md)，[OpenAI (ChatGPT)](https://chat.openai.com/)，[DeepL](https://www.deepl.com/translator)，[谷歌](https://translate.google.com)，[百度](https://fanyi.baidu.com/)，[火山翻译](https://translate.volcengine.com/translate) 和 [Bing 翻译](https://www.bing.com/translator)。
